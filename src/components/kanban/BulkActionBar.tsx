...
export function BulkActionBar({
  ...
  return (
    <>
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-dark-surface border border-dark-border rounded-xl shadow-2xl px-4 py-3 flex items-center gap-3">
        {/* Selection count */}
