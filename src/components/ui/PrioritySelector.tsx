...
export interface PrioritySelectorProps {
  /** Currently selected priority (undefined = no priority) */
  value?: Priority;
  /** Callback when priority changes (undefined = cleared) */
  ...
  className?: string;
  /** Allow clearing priority (show "None" option) */
  allowNone?: boolean;
}
      ...
      {allowNone && (
        <button
          ...
          className={clsx(
            ...
            value === undefined
              ? "bg-dark-border text-dark-text ring-1 ring-dark-muted"
