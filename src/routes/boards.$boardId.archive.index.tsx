    ...
    <div className="h-screen flex flex-col -mt-topbar">
      ...
      <div className="h-topbar pt-safe flex items-center justify-between px-4 border-b border-dark-border bg-dark-bg sticky top-0 z-30">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg text-dark-muted">Archive</span>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-dark-text mb-2">Archived Cards</h2>
            <p className="text-dark-muted">
              Deleted cards are moved here. You can restore them to their original column or permanently delete them.
            </p>
          </div>
          <ArchivedCardList boardId={boardId as Id<"boards">} />
        </div>
      </div>
    </div>
  );
